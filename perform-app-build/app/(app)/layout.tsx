  ...
  return (
    <div className="flex min-h-screen">
      ...
      <main className="flex-1 overflow-y-auto pb-[calc(5rem+env(safe-area-inset-bottom))] md:pb-0">
        ...
        <div className="sticky top-0 z-20 flex justify-end px-6 py-3 pt-[calc(0.75rem+env(safe-area-inset-top))] bg-bg-0/70 backdrop-blur-xl border-b border-border/80">
