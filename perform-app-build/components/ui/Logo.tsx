...
function FallbackMark({ size = 28 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* split ring */}
      <path d="M14 3 a11 11 0 0 0 0 22" stroke="#2563eb" strokeWidth="2" strokeLinecap="round" fill="none" />
      ...
      {/* pulse line */}
      <path d="M5 23 h5 l1.5 -3 2 6 1.5 -3 h7" stroke="#3b82f6" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" fill="none" />
    </svg>
  );
}
