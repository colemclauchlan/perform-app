...
import type { MeasurePoint } from "./BodyMeasureModel3D";

// three.js is client-only and code-split; never enters SSR or the main bundle.
const BodyMeasureModel3D = dynamic(() => import("./BodyMeasureModel3D"), {
  ssr: false,
  loading: () => (
...
/**
 * Framed, interactive 3D body viewer with measurement callouts plotted onto the
 * matching anatomy. Drag to rotate.
 */
export function BodyMeasureModel3DView({
  points = [],
  height = 440,
  autoRotate = false,
  className = "",
